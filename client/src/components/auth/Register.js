      ...
      <Form onSubmit={onSubmit}>
        <Form.Input
          ...
          style={{
            ...
            borderImage: name
              ? "linear-gradient(to right, #6065D9, #17D7FA) 1"
              : "",
            position: "relative",
            margin: "10px 0",
          }}
        ...
        <Form.Button
          ...
          onMouseOver={(e) =>
            (e.currentTarget.style.background =
              "linear-gradient(to right, #17D7FA, #6065D9)")
          }
          onMouseOut={(e) =>
            (e.currentTarget.style.background =
              "linear-gradient(to right, #6065D9, #17D7FA)")
          }
        >
