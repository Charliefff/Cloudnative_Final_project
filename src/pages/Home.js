import { Grid, Image, Button, Segment, Dropdown, Table, Input } from "semantic-ui-react";
...
function Home() {
  const [profileImage, setProfileImage] = useState("https://react.semantic-ui.com/images/wireframe/image.png");
  ...
  const options = [
    ...
    { key: "3", text: "Machine Specifications", value: "Machine Specifications" },
      ...
      <Grid.Row>
        <Grid.Column width={2}>
          <div>
            ...
            <Button basic onClick={handleButtonClick} style={{ marginTop: "1rem" }}>
        ...
        <Grid.Column width={13}>
          ...
          <div>
            ...
            />
            <Button basic onClick={handleConfirmClick} style={{ marginTop: "1rem" }}>
              Confirm
            </Button>
          </div>
